...
cp fixGit.sh _gvimrc _vimperatorrc _vimrc nsis.vim pythonConfig.vim %HOME%
...
if NOT "%is64%"=="" (
  ...
  cp python_editing.vim sessionman.vim supertab.vba supertab.vim taglist.vim "%programfiles%\Vim\vimfiles\plugin"
)
PAUSE
echo End
